...
public class ConsumerEnrichment
{
    ...
    /// Returns first non-null phone from priority order: mobile_phone_1-2, phone_1-5
    /// </summary>
    public string? normalized_phone =>
        mobile_phone_1 ?? mobile_phone_2 ?? phone_1 ?? phone_2 ?? phone_3 ?? phone_4 ?? phone_5;
